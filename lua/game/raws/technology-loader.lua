...
function d.load()
	TECHNOLOGY.resize_input_efficiency_boosts(50)
	TECHNOLOGY.resize_output_efficiency_boosts(50)
	TECHNOLOGY.resize_required_biome(50)
	TECHNOLOGY.resize_required_resource(50)
	TECHNOLOGY.resize_throughput_boosts(50)
