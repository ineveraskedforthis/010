...
function ll.load()
	...
	RACE.resize_female_efficiency(30)
	RACE.resize_male_efficiency(30)
	RACE.resize_female_needs_amount(30)
	RACE.resize_male_needs_amount(30)
	RACE.resize_needs_category(30)
	RACE.resize_needs_use_case(30)
	RACE.resize_portrait_per_age_bracket_female(10)
	RACE.resize_portrait_per_age_bracket_male(10)

	PORTRAIT_LAYER_GROUP.resize_group(10)
	PORTRAIT_SET.resize_layers(50)
	PORTRAIT_SET.resize_groups(25)
