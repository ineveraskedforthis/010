...
function wg.refresh_map_mode()
	...
	DATA.for_each_tile(function (tile_id)
		...
		pointer_tile_color[pixel_index * 4 + 0] = 255 * TILE.get_real_r(tile_id)
		pointer_tile_color[pixel_index * 4 + 1] = 255 * TILE.get_real_g(tile_id)
		pointer_tile_color[pixel_index * 4 + 2] = 255 * TILE.get_real_b(tile_id)
